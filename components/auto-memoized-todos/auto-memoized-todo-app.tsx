...
import TodoForm from './auto-memoized-todo-form';
import TodoList from './auto-memoized-todo-list';
import TodoStats from './auto-memoized-todo-stats';
  ...
  return (
    <StatisticsProfiler id="TodoApp-Component">
      <Card>
        ...
        <CardHeader>
          <CardTitle>Auto-memoized Todo List</CardTitle>
        </CardHeader>
